      ...
      <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
        {/* product data */}
          ...
          <div className="flex-1">
            ...
            <p className='text-gray-500'>Easy Returns exchange policy within 7 days.</p>
          </div>
          </div>
          {/* review section */}
          <div className="mt-20">
            ...
            <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
                  <p>An E-commerce websie is an online platform that facilitates the buying and selling</p>
